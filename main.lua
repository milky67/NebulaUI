...
-- MODIFIED FOR EXTERNAL CONFIGURATION & CORRECT INITIALIZATION

return function(userConfig, onReadyCallback)
    local NebulaUI = {}
    ...
    -- DEFAULT CONFIG (Is overwritten by your settings)
    -- Key, CreatorName, and LibraryName are now intended to be set by the user.
    local Config = {
        Key = "", 
        CreatorName = "User",
    ...
    -- Declare main UI components in a higher scope so they can be accessed by CreateTab
    local Main, Content, TabButtons
    ...
    local function CreateKeySystem()
        ...
        local draggableComponents = {KeyGui, Title, AuthorLabel} 
        ...
        Submit.MouseButton1Click:Connect(function()
            if KeyBox.Text == Config.Key then
                ...
                -- CRITICAL FIX: Execute the callback code AFTER the UI is initialized
                if onReadyCallback then
                    onReadyCallback(NebulaUI)
                end
            else
                KeyBox.Text = ""
    ...
    -- This function MUST be defined outside of Init so it's available from the start.
    function NebulaUI:CreateTab(Name)
        ...
        function Tab:Dropdown(Text, Options, Callback)
            ...
            List.Size = UDim2.new(1,0,0, #Options * 45 + 5)
            ...
            Arrow.MouseButton1Click:Connect(function()
                ...
                Drop.Size = UDim2.new(0,440,0,targetHeight)
            end)
        ...
        function Tab:Keybind(Text, DefaultKey, Callback)
            ...
            BindBtn.Position = UDim2.new(1,-120,0.5,-17.5)
    ...
    Init = function()
        ...
        NebulaUI:Notify("Welcome!", "NebulaUI v3 Loaded! Made by: " .. Config.CreatorName, 5)
    end
